# Exact same setup as jump_hop2.tcl (fixed platform -> platform2,
# diagonal jump) but WITHOUT neutralizing the rat - isolates whether
# the live, patrolling rat actually kills Sam during this specific jump
# at its natural real-time phase (rat starts moving the instant the
# room is entered, same as real play).

after time 6 { keymatrixdown 3 0x02 }
after time 6.3 { keymatrixup 3 0x02 }

set ::out [open ./build/uranium_hop2_liverat_log.txt w]
proc snap {label} {
...
after time 9.24 { keymatrixdown 8 0x50 }
after time 9.44 { keymatrixup 8 0x50 }
