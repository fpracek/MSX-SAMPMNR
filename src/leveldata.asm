...
;   dw rectsize, dw dataaddr(8000h-based), per-cell slab idx x2, bank
crumb_tab18:
        db 1,1,4,0,255,255,255,15,4,19,6
        dw 128, 32768
        db 26,255
        db 127
        db 1,5,4,0,255,255,255,23,8,27,14
        dw 384, 33152
        db 11,255
        db 127
        db 1,2,4,1,255,255,255,15,6,19,8
        dw 128, 34304
        db 20,255
        db 127
        db 1,4,4,1,255,255,255,19,8,23,10
        dw 128, 34688
        db 12,255
        db 127
        db 1,3,4,2,255,255,255,15,8,19,14
        dw 384, 35072
        db 13,255
        db 127
        db 1,6,4,2,255,255,255,21,11,25,17
        dw 384, 36224
        db 1,255
        db 127
        db 1,5,4,3,255,255,255,17,11,21,17
        dw 384, 37376
        db 2,255
        db 127
...
; crumb_tab20 (18B): ncells, (bx,y,bz)x2 FF-pad, c0,r0,c1,r1,
;   dw rectsize, dw dataaddr(8000h-based), per-cell slab idx x2, bank
crumb_tab20:
...
room20_name:
        db 84,72,69,32,70,73,78,65,76,32,66,65,82,82,73,69,82,0
