...
emit_room(R11, lines, map_out=os.path.join(ROOT,'src','level_map11.bin'), slab_out=os.path.join(ROOT,'src','slab_tab11.bin'))
emit_crumb_tab(R11, lines, bank_map={'a': CRUMBBANK})
emit_room(R12, lines, map_out=os.path.join(ROOT,'src','level_map12.bin'), slab_out=os.path.join(ROOT,'src','slab_tab12.bin'))
...
emit_room(R14, lines, map_out=os.path.join(ROOT,'src','level_map14.bin'), slab_out=os.path.join(ROOT,'src','slab_tab14.bin'))
